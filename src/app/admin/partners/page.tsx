      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Partners & Logos</h1>
              <p className="text-gray-600 mt-2">Manage partner logos and sponsorships displayed on the website</p>
            </div>
            <button
